v-container<script setup lang="ts">
          ...
          <v-col cols="12">
            <div class="d-flex justify-space-between align-center">
              <div>
                ...
                <p class="text-body-1 text-grey-darken-1 joss">
          ...
          >
            <v-card class="mx-auto" elevation="2" :loading="loading">
              <v-card-text class="pa-4">
                ...
                <h3 class="text-h6 font-weight-medium mb-2 outfit-title">
                  {{ role.title || "Untitled Role" }}
                </h3>

                <div
                  class="d-flex align-center text-body-2 text-grey-darken-1 joss"
                >
                ...
                <div
                  class="d-flex align-center text-body-2 text-grey-darken-1 my-3"
                ></div>
              </v-card-text>
            </v-card>
          </v-col>
          ...
          <v-col cols="12" sm="6" md="4" lg="3">
            ...
            >
              <v-card-text class="pa-4">
                ...
                <h3
                  class="text-h6 font-weight-medium mb-2 text-primary outfit-title"
                >
                  Add New Role
                </h3>
        ...
        <v-row v-if="filteredRoles.length === 0 && !searchQuery">
          <v-col cols="12">
            <div class="text-center py-12">
              ...
              <h3 class="text-h4 mb-3 outfit-title">No roles found</h3>
              <p class="text-body-1 text-grey-darken-1 mb-6 joss">
        ...
        <v-row v-if="filteredRoles.length === 0 && searchQuery">
          <v-col cols="12">
            <div class="text-center py-12">
              ...
              <h3 class="text-h5 mb-3 outfit-title">
              ...
              <div class="d-flex justify-center ga-3">
                <v-btn variant="outlined" @click="searchQuery = ''">
                  Clear Search
                </v-btn>
                <v-btn
                  color="primary"
