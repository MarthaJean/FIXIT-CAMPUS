              ...
              <v-row align="center" class="min-height-screen" justify="center">
                <v-col cols="12" lg="8" md="10">
                  <div class="text-center">
                    <h1
                      class="text-h2 text-md-h1 font-weight-bold mb-4 outfit-title"
                    >
                      {{ data.title }}
                    </h1>

                    <h2
                      class="text-h4 text-md-h3 text-grey-darken-1 mb-6 jost-text"
                    >
                      {{ data.subtitle }}
                    </h2>

                    <p
                      class="text-h6 text-md-h5 text-grey-darken-2 mb-8 jost-text"
                    >
                      {{ data.description }}
                    </p>
